...
int main()
{
	...
	// ----------------------------------------------------------------------
	//Insert values
	ExcelWorksheet ^xlsFirstTab = safe_cast<ExcelWorksheet^>(xls->easy_getSheet("SourceData"));
	...
	ExcelWorksheet ^xlsWorksheet = safe_cast<ExcelWorksheet^>(xls->easy_getSheet("SourceData"));
