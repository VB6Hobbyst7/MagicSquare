...
int main()
{
	...
	ExcelDocument ^xls = gcnew ExcelDocument(2, 1);
	...
	//Add the pivot table
	ExcelWorksheet ^xlsWorksheet = safe_cast<ExcelWorksheet^>(xls->easy_getSheet("Second tab"));
	...
	ExcelChartSheet ^xlsChartSheet = safe_cast<ExcelChartSheet^>(xls->easy_getSheet("Pivot chart"));
