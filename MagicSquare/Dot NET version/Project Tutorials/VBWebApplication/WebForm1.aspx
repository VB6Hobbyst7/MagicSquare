<%@ Page Language="vb" AutoEventWireup="false" Codebehind="WebForm1.aspx.vb" Inherits="VBWebApplication.WebForm1"%>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:DataGrid id=dgTimeSheetReport style="Z-INDEX: 105; LEFT: 48px; POSITION: absolute; TOP: 144px" runat="server" Width="800px" ShowFooter="True" DataSource="<%# dsSource %>" AutoGenerateColumns="False">
			...
			<asp:Label id="lblError" style="Z-INDEX: 114; LEFT: 184px; POSITION: absolute; TOP: 560px"
				runat="server" ForeColor="Red"></asp:Label>
			<asp:CheckBox id="chkNBHours" style="Z-INDEX: 112; LEFT: 88px; POSITION: absolute; TOP: 528px"
			...
			<asp:Label id="Label4" style="Z-INDEX: 111; LEFT: 48px; POSITION: absolute; TOP: 392px" runat="server"
			...
			<asp:Button id="btnExportToExcel" style="Z-INDEX: 100; LEFT: 48px; POSITION: absolute; TOP: 560px"
